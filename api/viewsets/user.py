...
from api.serializers import (
    UserSerializer, UserReadSerializer, UserBaseSerializer)

# utils
from api.utils.emails import send_mail_password_recovery, send_mail_active_account
...
def decode_jwt_token(username, token):
    try:
        ...
        if payload['type'] != 'password_recovery':
            raise ValidationError('Link invalido')
