...
const PaginaPublica = () => {
    ...
    return (
        <>
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded " style={{backgroundColor: "#17527f"}}>
    <div className="container flex flex-wrap justify-between items-center mx-auto">
      <div className="flex items-center">
          <div className="mr-3 h-6 sm:h-9"></div>
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Casa del migrante</span>
      </div>
      
          <div>
            <a href="#" className="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Iniciar sesión</a>
          </div>
    </div>
  </nav>
                    ...
                    <div className="flex flex-col justify-center items-center text-center rounded-t-lg md:rounded-t-none md:rounded-tl-lg row-span-1">
                        ...
                        <div className="mx-auto max-w-2xl text-gray-500">
                            <p className="my-4 text-gray-900 text-base">
                                Esta herramienta te permite averiguar si tu
                                familiar ha pasado por alguna de las casas del
                                migrante.
                            </p>
                        </div>
                    </div>
            ...
            <p className="text-center m-12">
                Casas del migrante donde ha estado,, para más información
                comunícate a los siguientes centros:
            </p>
            ...
            <div className="container mx-auto m-10">
                <div className=" p-6 md:max-w-sm sm:m-10 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <p className="font-normal text-gray-700 dark:text-gray-100">
                        Tu familiar si estuvo en la casa del migrante, para más
                        información comunícate directamente con ellos.
                    </p>
                </div>
